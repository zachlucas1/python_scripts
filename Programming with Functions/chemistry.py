...
def main():
    try:
        molecule_formula = input('Please enter a formula for a molecule: ')
        formula_parse_conversion = parse_formula(molecule_formula)
        molar_mass_conversion = molar_mass(formula_parse_conversion)
    ...
    print(f'{round(molar_mass_conversion, 5)} grams/mole')

    moles = mass / molar_mass_conversion
